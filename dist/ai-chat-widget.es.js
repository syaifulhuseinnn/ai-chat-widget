...
class o {
  constructor(e = {}) {
    this.userId = e.userId, this.apiUrl = e.apiUrl || "https://888.syaifulhuseinnn.pro/webhook/5e174ada-8250-4320-b0c2-bad652aab9b0", this.placeholder = e.placeholder || "Type your message... (Press Enter to send, Shift + Enter for new line)", this.isLoading = !1, a.setOptions({
      breaks: !0,
      gfm: !0
...
`, t = document.createElement("div");
  ...
  setLoading(e) {
    this.isLoading = e, e ? (this.loadingIndicator.classList.remove("aic-hidden"), this.input.disabled = !0) : (this.loadingIndicator.classList.add("aic-hidden"), this.input.disabled = !1, this.input.focus());
  }
  showResponse(e, t = !1) {
    t ? this.responseContent.innerHTML = a(e) : this.responseContent.textContent = e, this.responseArea.style.height = "auto", this.responseArea.style.opacity = "1", this.responseArea.style.marginBottom = "1rem";
  }
  async sendMessage() {
...
typeof window < "u" && (window.AIChatWidget = o);
export {
  o as AIChatWidget,
  o as default
};
