(function(s,i){typeof exports=="object"&&typeof module<"u"?i(exports,require("marked")):typeof define=="function"&&define.amd?define(["exports","marked"],i):(s=typeof globalThis<"u"?globalThis:s||self,i(s.AIChatWidget=s.AIChatWidget||{},s.marked))})(this,function(s,i){"use strict";class o{constructor(e={}){this.userId=e.userId,this.apiUrl=e.apiUrl||"https://888.syaifulhuseinnn.pro/webhook/5e174ada-8250-4320-b0c2-bad652aab9b0",this.placeholder=e.placeholder||"Type your message... (Press Enter to send, Shift + Enter for new line)",this.isLoading=!1,i.marked.setOptions({breaks:!0,gfm:!0}),this.createWidget(),this.setupElements(),this.setupEventListeners()}createWidget(){const e=`
